...
-- mysql -u root -p proj < backup.sql
-- mysqldump -u root -p proj > backup.sql
...
(
    `id`          bigint NOT NULL,
    `detailType`  enum('ATTACHED_FILE','URL') NOT NULL,
    `details`     varchar(255) DEFAULT NULL,
    `entityId`    bigint NOT NULL,
    `entityType`  enum('COMPANY','PRODUCT','RELEASE','RESOURCE') NOT NULL,
